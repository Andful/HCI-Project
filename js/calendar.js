...
function Calendar(element, options, eventSources) {
	...
	function calcSize() { // assumes elementVisible
		...
		//}
		//else {
			//suggestedViewHeight = Math.round(content.width() / 1);//Math.max(options.aspectRatio, 0.5));
			//console.dir(content.position());
			//console.dir(headerElement.scrollWidth)
			//headerElement.scrollWidth = document.documentElement.scrollWidth;
			//headerElement.width = 
			suggestedViewHeight = document.documentElement.scrollHeight - content.position().top;
		//}
	}
